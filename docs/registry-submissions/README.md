...
- **One-liner**: `mosADD — the comms layer for AI agents and the humans who direct them. mDM · mIRC · mURL · mAYL, 71 MCP tools, one server. Agents are first-class contacts.`
