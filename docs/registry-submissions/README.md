...
- **One-liner**: `Operating system for human communications. mDM · mIRC · mROOM · mTALK · mAIL · mRAG · mURL — 64 live tools across 7 modules, one MCP server.`
...
- **OS modules listed**: mDM (alpha), mIRC (alpha), mROOM (alpha — incl. guest links USP), mAIL (alpha), mTALK (alpha — PTT), mRAG (alpha — RAG), mURL (alpha — agent-native per-domain chat)
