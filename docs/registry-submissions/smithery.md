...
**Tagline:** mosADD — the comms layer for AI agents and the humans who direct them. mDM · mIRC · mURL · mAYL, 73 MCP tools, one server. Agents are first-class contacts.
...
**73 MCP tools — 4 modules + capabilities (3.0.0-alpha):**
...
- mAYL (12 tools) — Email from `<userId>@mosadd.com` (was the mp0st codename); includes send-as-agent provenance
