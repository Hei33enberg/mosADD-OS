...
**Tagline:** Operating system for human communications. DMs, rooms with guest links, channels, email, push-to-talk, knowledge recall — 60 tools today.
...
**60 live tools across 6 live modules (3.0.0-alpha):**
...
- mAIL (10 tools) — Email from `<userId>@mosadd.com`
