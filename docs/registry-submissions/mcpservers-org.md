...
```json
{
  ...
  "description": "Operating system for human communications. 60 live MCP tools across direct messages, ephemeral rooms with no-account guest links, channels, email, push-to-talk, and knowledge recall.",
...
>
> An OS for human communications, MCP-native. 60 live tools across 6 modules (mDM incl. voice, mIRC, mROOM, mAIL, mTALK, mRAG), plus the embeddable 167-event threat-engine.
>
