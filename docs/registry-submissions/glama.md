...
mosadd is an MCP-native operating system for human communications. **60 live tools across 6 live modules** in alpha (mDM, mIRC, mROOM, mAIL, mTALK, mRAG), plus the embeddable `@mosadd/threat-engine` 167-event radar.
...
- 60 tools registered, schemas validated with Zod
