...
mosadd is an MCP-native operating system for human communications. **64 live tools across 7 live modules** in alpha (mDM, mIRC, mROOM, mAIL, mTALK, mRAG, mURL), plus the embeddable `@mosadd/threat-engine` 167-event radar.
