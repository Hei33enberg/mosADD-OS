// v0.4 — tighter, monospace, true mosadd.dev look.
// Smaller paddings, border-1, hud-style decorations, less chrome.
...
.c0-bg { position: absolute; inset: 0; pointer-events: none; z-index: 0;
  background-image:
    linear-gradient(rgba(0,255,122,0.06) 1px, transparent 1px),
...
.c0-notice { padding: 4px 8px; font-size: 10px; line-height: 1.4;
  color: rgba(255,255,255,0.4); background: rgba(0,0,0,0.85);
  border-bottom: 1px solid rgba(255,255,255,0.08);
  letter-spacing: 0.01em; }
.c0-notice b { color: rgba(0,255,122,0.85); font-weight: 600; }

/* FEED — irc style, tight rows. */
.c0-feed { flex: 1; min-height: 0; overflow-y: auto; padding: 6px 8px;
  display: flex; flex-direction: column; gap: 1px; }
.c0-row { display: flex; gap: 6px; align-items: baseline; font-size: 12px; }
.c0-time { color: rgba(255,255,255,0.3); font-size: 10px; flex-shrink: 0; min-width: 38px; }
...
.c0-system .c0-nick { color: rgba(255,255,255,0.3); }
.c0-system .c0-text { color: rgba(255,255,255,0.45); font-style: italic; }
...
.c0-prejoin-row input { flex: 1; min-width: 0;
  ...
  font-family: inherit; }
.c0-prejoin-row input:focus { border-color: #00ff7a;
  background: rgba(0,255,122,0.04); }
.c0-prejoin-row input::placeholder { color: rgba(255,255,255,0.25); }
.c0-prejoin-go { flex-shrink: 0;
  background: #00ff7a; color: #000;
  border: 1px solid #00ff7a; padding: 0 12px;
  font-size: 11px; font-weight: 700;
  text-transform: uppercase; letter-spacing: 0.1em;
  cursor: pointer; font-family: inherit; }
.c0-prejoin-go:hover { background: #fff; border-color: #fff; }
.c0-prejoin-alt { display: inline-block; margin-top: 6px;
  font-size: 9.5px; font-weight: 700; text-transform: uppercase;
  letter-spacing: 0.08em; color: rgba(0,255,122,0.75);
  text-decoration: none; border-bottom: 1px solid rgba(0,255,122,0.4); }
.c0-prejoin-alt:hover { color: #00ff7a; border-color: #00ff7a; }

/* COMPOSE (joined state) — same compact treatment. */
.c0-compose { display: flex; gap: 4px; padding: 8px;
  background: #000; border-top: 1px solid rgba(255,255,255,0.2); }
...
.c0-compose input:focus { border-color: #00ff7a;
  background: rgba(0,255,122,0.04); }
.c0-compose input::placeholder { color: rgba(255,255,255,0.25); }
