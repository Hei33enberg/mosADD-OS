    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="container py-12">
        ...
        <p className="mt-4 text-muted-foreground max-w-2xl">
          Self-serve dashboard for <code>@mosadd/mcp</code>. Sign in, issue an API key, paste a one-line install snippet into Claude Code / Cursor / your agent. 71 MCP tools across the four modules (mDM · mIRC · mURL · mAYL) plus capabilities (mTALK, mRAG, comms_), $0 to start.
        </p>
