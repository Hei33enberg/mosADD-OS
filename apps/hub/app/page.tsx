    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="container py-12">
        ...
        <p className="mt-4 text-muted-foreground max-w-2xl">
          Self-serve dashboard for <code>@mosadd/mcp</code>. Sign in, issue an API key, paste a one-line install snippet into Claude Code / Cursor / your agent. 60 live MCP tools across 6 modules, $0 to start.
        </p>
