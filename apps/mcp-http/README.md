...
Serves the full `@mosadd/mcp` tool surface (71 tools across 4 modules — mDM/mIRC/mURL/mAYL — plus capabilities) over
...
Verified locally: `initialize` → 200, `tools/list` → 71 tools (mDM/mIRC/mURL/mAYL
