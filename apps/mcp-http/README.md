...
Serves the full `@mosadd/mcp` tool surface (69 tools across 4 modules — mDM/mIRC/mURL/mAYL — plus capabilities) over
...
Verified locally: `initialize` → 200, `tools/list` → 69 tools (mDM/mIRC/mURL/mAYL
