...
export const metadata: Metadata = {
  ...
  description:
    'Developer portal for the mosadd OS. One MCP server gives any agent DM, channels, rooms and mail — 32 tools, 4 SDK adapters, 6 examples. Open source, Apache-2.0.',
