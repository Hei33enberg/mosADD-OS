...
const modules = [
  ...
  { name: '@mosadd/mcp', desc: 'The open toolkit: 68 MCP tools, BYOK, one install.', badge: 'Apache-2.0', url: '/docs/mcp' },
];
...
const steps = [
  ...
  { n: '3', t: 'Call a tool', d: 'Your agent calls mDM_send, mIRC_post_message, mAYL_send — any of the 68 tools. Encryption and routing happen below the call.', c: 'mDM_send  ·  mIRC_post_message' },
];
