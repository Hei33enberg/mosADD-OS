...
export default function McpPage() {
  return (
    <Prose>
      ...
      <P>
        Total surface today: <strong>43 tools across 6 modules</strong> — mDM ×6, mIRC ×17, mROOM ×8, mAIL ×2, mTALK ×5, mKB ×1, plus the <code className="font-mono text-primary">comms_capabilities</code> discovery tool.
      </P>
