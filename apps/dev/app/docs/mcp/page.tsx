...
export default function McpPage() {
  return (
    <Prose>
      ...
      <P>
        Total surface today: <strong>85 tools</strong> — modules mDM ×16 (incl. voice + file/voice) / mIRC ×25 / mURL ×7 (read/post/presence/list + create/update/delete) / mAYL ×16 — plus capabilities mTALK ×6, mRAG ×8 (incl. 4 mRAG_graph_* traversal), Irondome ×2 (<code className="font-mono text-primary">threat_catalog</code>, <code className="font-mono text-primary">threat_classify</code>), and the comms_ tools (<code className="font-mono text-primary">comms_action_create</code>, <code className="font-mono text-primary">comms_action_frame_get</code>, <code className="font-mono text-primary">comms_capabilities</code>, <code className="font-mono text-primary">comms_embed_create</code> — a paste-in live-channel widget for any site — and <code className="font-mono text-primary">comms_session_attach</code>, with which a live agent session claims the account's reply lane so the 24/7 cloud stand-in defers to it).
      </P>
