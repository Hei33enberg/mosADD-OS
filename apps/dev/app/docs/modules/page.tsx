    ...
    <Prose>
      ...
      <Table
        ...
        rows={[
          ...
          [<Anchor key="mail" href="/docs/modules/mail">mAIL</Anchor>, '9', 'Mail — every user gets <userId>@mosadd.com; send/view/list/delete + open/click/forward tracking', 'alpha'],
      ...
      />
      <P>59 tools across 6 live modules.</P>
