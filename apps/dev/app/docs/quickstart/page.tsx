  ...
  "mcpServers": {
    "mosadd": {
      ...
      <P>
        ...
        scoped session, so every tool acts as the key&apos;s owner. mAYL (email) and voice run through the mosadd
...
MOSADD_USER_JWT=...   # a signed-in user's access token`}</Pre>
      ...
      <H3>Next steps</H3>
      <Ul>
        <li><Anchor href="/docs/mcp">MCP server reference</Anchor> — 73 tools, control/data plane split, transports</li>
