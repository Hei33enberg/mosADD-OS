...
[![Tools](https://img.shields.io/badge/tools-59%20live-00ff7f)](packages/mcp)
...
| **mAIL** (9) | `mAIL_send`, `mAIL_view`, `mAIL_list`, `mAIL_delete`, `mAIL_stats`, `mAIL_events`, `mAIL_metrics`, `mAIL_revoke`, `mAIL_audit_export` | Every user gets `<userId>@mosadd.com` for free |
...
**59 tools across 6 live modules** (12+20+9+5+9+4), plus the `comms_capabilities` discovery tool. All names follow [RFC 0001](./docs/rfcs/0001-module-naming.md) — `m<MODULE>_<operation>` snake_case.
