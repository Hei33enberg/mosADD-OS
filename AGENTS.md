...
- **Encryption honesty:** only mDM is E2EE. Never write copy claiming otherwise — check every claim against [docs/security/e2ee-posture.md](./docs/security/e2ee-posture.md) ("What copy is allowed to say"). The honesty-lint in CI will fail your PR on banned phrases.
