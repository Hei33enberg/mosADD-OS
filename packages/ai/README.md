...
Framework adapters for [mosadd](https://mosadd.dev) — use the 38 mosadd OS tools directly from your favorite agent framework without spinning up the MCP server.
